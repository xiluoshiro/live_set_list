...
一个前后端分离的 BanG Dream! Live / setlist 资料库。匿名用户可以搜索和浏览演出、活动组与巡演资料，登录用户可以同步逐场收藏，`editor+` 用户可以通过控制台维护 Live、歌曲、场馆、setlist、巡演和活动组。
...
- `editor+` 控制台支持新增和更新 Live、歌曲、场馆、版本化 Setlist（含历史名称、旧/新阵容与交接基准），以及创建和更新巡演、活动组关系。
