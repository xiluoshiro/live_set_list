...
- 演出资料自动聚合多日 Live 与单日午场 / 晚场；完整收藏时在“仅收藏”中聚合，部分收藏时保留逐场项目。
...
- `editor+` 控制台支持新增和更新 Live、歌曲、场地、追加 setlist，以及创建和更新巡演、活动组关系。
- Flyway 管理 PostgreSQL schema；当前仓库 migration 为 B1 + V2~V20。
