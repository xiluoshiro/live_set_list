...
- `P0` 补齐隐私说明，并明确登录、收藏、错误反馈、访问统计与第三方 SDK 的数据边界
- `P0` 配置可用的外部反馈入口：GitHub Issues / Discussions、邮箱或项目主页至少确认一种
- `P1` 全部内容列表继续增强年份、Live 类型、乐队 / 艺人筛选
...
- `P2` 评估截图型视觉回归测试，重点看护顶部导航、首页、详情弹窗和控制台的全局样式回归
