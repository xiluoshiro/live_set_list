...
4. 进入“新增Live”。
5. 选择 seed 中已有 venue。
6. 填写唯一标题，例如 `E2E Live <timestamp>`。
7. 点击“提交插入”。
8. 断言出现“已新增Live #...”，并取得 live_id。
9. 切到“新增Setlist”。
10. 断言下拉候选包含新 live。
11. 断言 live 候选总数比初始总数多 1。
12. 切到“全部内容”。
13. 断言新 live 出现在列表里。
14. 再切回“控制台 -> 新增Setlist”。
15. 断言新 live 仍在候选里。
