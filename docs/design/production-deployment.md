...
- 当前仓库 migration 已到 V17，但本文没有生产 V14~V17 的 `flyway info` 或发布验收证据，因此生产确认状态仍停留在 V13。
...
- [ ] 为 V14~V17 安排 migration release，并在 runbook 记录生产 `flyway info`、owner 契约、应用切换和公网 smoke 证据。
